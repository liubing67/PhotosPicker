...
public class PhotoPickerFragment extends Fragment {
  ...
  @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    photoGridAdapter.setOnCameraClickListener(new OnClickListener() {
      @Override public void onClick(View view) {
        ...
        {
          if (RequestPermissionsUtil.requestPer(getActivity(), Manifest.permission.WRITE_EXTERNAL_STORAGE, 2)){
            openCamera();
          }else {
  ...
  private void openCamera() {
    try {
      Intent intent = captureManager.dispatchTakePictureIntent(null);
  ...
  public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
    ...
    switch (requestCode)
    {
      case 1:
        ...
        break;
      case 2:
        RequestPermissionsUtil.onRequestPermissionsResult(getActivity(), Manifest.permission.READ_EXTERNAL_STORAGE, requestCode, permissions, grantResults);
        break;
    }
  ...
  private void promptNoPermission(int res) {
    Snackbar.make(layoutContainer, res, Snackbar.LENGTH_LONG).setAction(R.string.btn_setting, new OnClickListener() {
      @Override
